...
public class PagerProvider extends ContentProvider {
    ...
    static {
        ...
        URL_MATCHER.addURI("com.github.android.klaxon", "pages", PAGES);
        URL_MATCHER.addURI("com.github.android.klaxon", "pages/#", PAGE_ID);
        URL_MATCHER.addURI("com.github.android.klaxon", "reply", REPLIES);
        URL_MATCHER.addURI("com.github.android.klaxon", "reply/#", REPLY_ID);
    }
